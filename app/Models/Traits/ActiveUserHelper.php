...
trait ActiveUserHelper
{
    ...
    public function getActiveUsers()
    {
        return Cache::remember($this->cache_key, $this->cache_expire_in_seconds, function () {
            return $this->caculateActiveUsers();
        });
    }

    public function caculateAndCacheActiveUsers()
    {
        $active_users = $this->caculateActiveUsers();

        $this->cacheActiveUsers($active_users);
    }

    private function caculateTopicScore () {
    ...
    private function caculateReplyScore () {
    ...
    private function caculateActiveUsers() {
        $this->caculateTopicScore();
        $this->caculateReplyScore();
